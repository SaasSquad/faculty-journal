  ...
  const JournalGrid = ({ journals }) => {
    return (
      <div className="bg-[#ffffff] md:mx-24 p-4 md:px-10 md:py-16">
        <div className='flex mb-[50px]'><Link to="/submissions"><button  className="rounded-lg px-4 md:px-8 py-2 text-white bg-[#2516d4] mt-4 md:mt-0">View submissions</button></Link> <button  className="rounded-lg px-4 md:px-8 py-2 text-white bg-[#2516d4] mt-4 md:mt-0 ml-[auto]"><Link to="/permission">View roles</Link></button></div>
