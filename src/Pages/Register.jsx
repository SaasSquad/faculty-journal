      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-md bg-blue-900 rounded-lg bg-opacity-95 p-8 text-white">
        ...
        <div className="bg-opacity-25 rounded-md p-4 relative">
          ...
          <div className="mb-4">
            ...
            <select value={academicStatus} name="option" onChange={e => setAcademicStatus(e.target.value)} required className="block w-full p-2 border border-gray-300 text-black rounded-md focus:outline-none focus:border-blue-500">
