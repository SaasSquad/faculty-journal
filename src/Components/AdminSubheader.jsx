    ...
    return (
        <>
            <div className='flex mb-[20px]'>
                <Link to="/submissions" className="rounded-lg px-4 md:px-8 py-2 text-white bg-[#2516d4] mt-4 md:mt-0">Edit Journals</Link>
                 <Link to="/permission" className="rounded-lg px-4 md:px-8 py-2 text-white bg-[#2516d4] mt-4 md:mt-0 ml-[auto]">View Editors</Link>
            </div>
