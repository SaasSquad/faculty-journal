const Publish = ({ onClose }) => {
    return ( <>
    <section className="mt-[5vh] w-[80vw] h-[40vh] ml-[10vw] absolute bg-[#D9D9D9] lg:w-[90vw] lg:ml-[5vw] lg:h-[90vh]">
        <div className="w-[60vw] ml-[10vw] flex-col mt-[10vw] lg:ml-[15vw] lg:mt-[7vh]">
            ...
            <button className="mt-[20px] w-[100%] bg-[#2516D4] py-[5px] rounded-[10px] text-[10px] text-[white] lg:py-[15px] lg:text-[12px]" onClick={onClose}>PUBLISH</button>
        </div>
    </section>
    </> );
}
